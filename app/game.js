...
/*console.log(Game.find({ $query: {}, $orderby: { _id : -1 } }));*/
...
io.on('connection', function(socket){
    ...
    app.get('/cardsdistrib',function(req, res) {
        ...
        switch (req.session.passport.user){ 
               case ("57d9aeab2445dc4c11a74de2"):
               /*case ("580f80a0520964b80f8eeef0"):*/
               player1id=req.session.passport.user;
        ...
        if ((cardsamount!=0)&&(cardsplayer1[0]===undefined)){
           ...
           break;
             case ("57d3167eda1149e41bb33b1a"):
              /*case ("580f8114520964b80f8eeef1"):*/
              player2id=req.session.passport.user;
    ...
    app.get('/skipwinner', function(req, res) {
        ...
        if ((pointsplayer1!=0)&&(pointsplayer2!=0)&&(pointsplayer1!=NaN)&&(pointsplayer2!=NaN)){
